const ATTACK_VALUE = 10; //Global constant value
...
function endRound() {
    ...
    if (currentPlayerHealth <= 0 && hasBonusLife) {
        ...
        alert("Saved! Otherwise You'd Be Dead");
    }
...
function printLogHandler() {
    ...
    //You have access to the element only
    // You can manually access the index with an extra variable
}
